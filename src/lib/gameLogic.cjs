// CJS version of gameLogic for use in custom server
...
function determineMultiplayerWinner(playerChoices) {
 ...
 */
function getComputerChoice(difficulty = 'medium', playerLastChoice = null) {
  if (difficulty === 'easy') {
...
module.exports = { CHOICES, CHOICE_KEYS, determineWinner, determineMultiplayerWinner, generateRoomCode, getComputerChoice };
